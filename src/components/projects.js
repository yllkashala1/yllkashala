...
export default function Projects() {
  return (
    <section className="projects-container">
      ...
      {/* <p className="subtitles">User Interface Projects</p> */}
      ...
      <p className="projects-soon">
        All these projects are currently in progress and will be available soon. For more information, feel free to <a href="mailto:shala.yllkaa@gmail.com" className="contact-link">contact me</a>!
      </p>
      {/* <div class="carousel">
        <div class="carousel-track">
          ...
          <div class="card">
            <img src="/images/pocket-nurse.png" alt="Project 2"/>
          </div>
          <div class="card">
            <img src="/images/elixir-elegance.png" alt="Project 3"/>
          </div>
        </div>
      </div> */}
      <div>
